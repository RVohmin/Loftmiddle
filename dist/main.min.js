    ...
    function initialise(containerSelector, options) {
      ...
      */
      ...
      function onMouseEnterOrLeave(e) {
        ...
        var type = e.type;
        var isInsideOneNormalScroll = false; //coming from closing a normalScrollElements modal or moving outside viewport?
      ...
      */
      ...
      function destroy(all) {
        setAutoScrolling(false, 'internal'); // setAllowScrolling(true);
      ...
      */
      ...
      function displayWarnings() {
        ...
        if (!isOK) {// showError('error', 'Fullpage.js version 3 has changed its license to GPLv3 and it requires a `licenseKey` option. Read about it here:');
...
(function () {
  document.addEventListener("DOMContentLoaded", function () {
    ...
    var li = teamList.getElementsByClassName("team__list-item");

    for (var i = 0; i < li.length; i++) {
      li[i].addEventListener("click", function (e) {
        e.preventDefault();
        var current = document.getElementsByClassName("team__list--active");
    ...
    send.addEventListener('click', function (event) {
      ...
      if (validateForm(myForm)) {
        ...
        data.append("to", "frodo@gmail.com"); // проверка содержимого data
        ...
        xhr.addEventListener('load', function () {
          if (xhr.response.status === 1) {
            ...
            console.log(xhr.response); //popup-message
